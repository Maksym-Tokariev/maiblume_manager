...
import {MongoGroupService} from "../services/mongo/MongoGroupService";
...
export class ServiceContainer {
    ...
    private readonly mongoGroupService: MongoGroupService;
    ...
    constructor(connector: MongoConnection) {
        ...
        this.mongoGroupService = new MongoGroupService(connector.getDb());
        ...
        this.inputListener = new InputListener(this.telegramBot, this.eventFactory, this.mongoGroupService);
    }
